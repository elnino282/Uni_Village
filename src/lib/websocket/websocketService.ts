...
class WebSocketService {
    ...
    subscribeToAck(
        ...
        const subscription = stompClient.subscribe<AckEvent>(destination, (message) => {
            onAck(message.data);
        });
    ...
    subscribeToIncomingMessages(
        ...
        const subscription = stompClient.subscribe<ChatMessageEvent>(destination, (message) => {
    ...
    subscribeToConversationEvents(
        ...
        const subscription = stompClient.subscribe<ConversationUpgradedEvent>(destination, (message) => {
